...
export default function Footer() {
  return (
    <div className="flex  w-full justify-center bg-[#4338CA] mt-7.5 md:mt-13">
      <div className="flex max-w-360 md:flex-row w-full flex-col md:px-20 md:py-10 px-5 py-10 gap-7   text-white  justify-between">
