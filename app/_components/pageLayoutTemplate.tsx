...
export default function PageLayoutTemplate({
  ...
  return (
    <div className="flex flex-col min-h-screen dark:bg-black text-black dark:text-white">
      <Header />

      <main className="flex-1 w-full max-w-360 dark:bg-black mx-auto md:p-20 pt-22.5 px-5 md:pt-32">
        {loading ? (
          <PageMoviesSkeleton />
        ) : (
          <div className="mb-8">
